...
#ifdef LUT3D
float _ColorGrading3D_Scale;
float _ColorGrading3D_Offset;
sampler3D _ColorGrading3D_Lut;

float3 ColorGrade3D(float3 c) {
    return tex3D(_ColorGrading3D_Lut, c.rgb * _ColorGrading3D_Scale + _ColorGrading3D_Offset).rgb;
}
